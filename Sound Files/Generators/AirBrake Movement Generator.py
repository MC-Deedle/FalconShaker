...
def create_concurrent_sound_file(frequency1, frequency2, output_file='AirBakeDrag.wav'):
    ...
    lcm_period = lcm(int(period1 * 1000), int(period2 * 1000)) / 1000  # Find LCM in seconds
...
# Write the combined wave to a WAV file
    wavfile.write("../AirBrakeMove.wav", sample_rate, combined_wave)
    print(f"Sound file {output_file} generated successfully!")

# Example of usage
frequency1 = 70
frequency2 = 75
create_concurrent_sound_file(frequency1, frequency2)
